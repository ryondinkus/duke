...
local function onRelease(player)
	local minion = Isaac.Spawn(EntityType.ENTITY_PICKUP, Isaac.GetEntityVariantByName("Fiend Minion (Half Immoral)"), 3, player.Position, Vector.Zero, player)
...
return {
	...
	sfx = Isaac.GetSoundIdByName("Fiend Heart Pickup"),
	callbacks = {
		{
